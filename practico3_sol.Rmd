...
$$\lim\limits_n F_n(x) = \lim\limits_n \left( \frac{1}{2} \, \mathbb{I}_{ \{ 0 \leq x < 1/n \} } + \mathbb{I}_{ \{ x \geq 1/n\} } \right) = \frac{1}{2} \, \underbrace{ \lim\limits_n \mathbb{I}_{ \{ 0 \leq x < 1/n \} } }_{ \overset{n}{\rightarrow} \mathbb{I}_{ \{ x = 0 \} } } + \underbrace{ \lim\limits_n \mathbb{I}_{ \{ x \geq 1/n\} } }_{ \overset{n}{\rightarrow} \mathbb{I}_{ \{ x \geq 0 \} } } =$$
$$= \frac{1}{2} \, \mathbb{I}_{ \{ x = 0 \} } + \mathbb{I}_{ \{ x \geq 0 \} } = \frac{1}{2} \, \mathbb{I}_{ \{ x = 0 \} } + \mathbb{I}_{ \{ x = 0 \} } + \mathbb{I}_{ \{ x > 0 \} } = \frac{3}{2} \, \mathbb{I}_{ \{ x = 0 \} } + \mathbb{I}_{ \{ x > 0 \} }$$
...
$$\lim\limits_n F_n(0) = \lim\limits_n \left( \frac{3}{2} \, \mathbb{I}_{ \{ x = 0 \} } \right) = \frac{3}{2} \neq 1 = F_0 (0)$$
...
$$\lim\limits_{ \substack{ p_n \rightarrow p \\ n \rightarrow +\infty }} F_{X_n}(x) = \lim\limits_{ \substack{ p_n \rightarrow p \\ n \rightarrow +\infty }} P(X_n \leq x) = \lim\limits_{ \substack{ p_n \rightarrow p \\ n \rightarrow +\infty }} 1 - (1 - p_n)^{\lfloor x \rfloor} = 1 - (1 - p)^{\lfloor x \rfloor} \Rightarrow X_n \overset{d}{\rightarrow} X \sim Geo(p)$$

## Parte b

$$\lim\limits_{ \substack{ p_n \rightarrow 0 \\ np_n \rightarrow \lambda \\ n \rightarrow +\infty }} F_{\frac{X_n}{n}}(x) = \lim\limits_{ \substack{ p_n \rightarrow 0 \\ np_n \rightarrow \lambda \\ n \rightarrow +\infty }} P \left( \frac{X_n}{n} \leq x \right) = \lim\limits_{ \substack{ p_n \rightarrow 0 \\ np_n \rightarrow \lambda \\ n \rightarrow +\infty }} P \left( X_n \leq nx \right) = \lim\limits_{ \substack{ p_n \rightarrow 0 \\ np_n \rightarrow \lambda \\ n \rightarrow +\infty }} 1 - (1 - p_n)^{\lfloor nx \rfloor} =$$
...
Por lo tanto, $\frac{X_n}{n} \overset{d}{\rightarrow} X \sim Exp(1/\lambda)$.

# Ejercicio 12

## Parte a: hallar función límite

Si $X_n \sim Unif(-n, \, n) \Rightarrow F_n(x) = \frac{x+n}{2n} \mathbb{I}_{[-n, \, n]} + \mathbb{I}_{[n, \, +\infty)}$. Luego,

$$\lim\limits_n F_{X_n}(x) = \lim\limits_n P(X_n \leq x) = \lim\limits_n \frac{x+n}{2n} \mathbb{I}_{[-n, \, n]} + \mathbb{I}_{[n, \, +\infty)} =$$
...
$$\lim\limits_n F_{\frac{X_{(n)}}{n^{1/\alpha}}}(x) = \lim\limits_n P \left( \frac{X_{(n)}}{n^{1/\alpha}} \leq y \right) = \lim\limits_n P \left( X_{(n)} \leq y \, n^{1/\alpha} \right) =$$
...
$$\lim\limits_n F_{ X_{(n)} - \log n}(x) = \lim\limits_n P \left( X_{(n)} - \log n \leq x \right) = \lim\limits_n P \left( X_{(n)} \leq x + \log n \right) =$$
...
$$F_Y(y) = P \big(Y \leq y \big) = P \big( F_X(X) \leq y \big) = P \big( X \leq F_X^{-1}(y) \big) = F_X \big( F_X^{-1}(y) \big) = y$$

## Parte b

Sea $X = F_X^{-1}(Y)$. Luego entonces:

$$F_X(x) = P \big(X \leq x \big) = P \big( F_X^{-1}(Y) \leq x \big) = P \big( X \leq F_X(x) \big) = F_X(x)$$
