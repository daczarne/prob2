...
$$\lim\limits_{m \rightarrow + \infty} 1 - (1 - p_m)^{ \frac{x}{p_m} - 1 } \leq \lim\limits_{m \rightarrow + \infty} 1 - (1 - p_m)^{ \left\lfloor \frac{x}{p_m} \right\rfloor } \leq \lim\limits_{m \rightarrow + \infty} 1 - (1 - p_m)^{ \frac{x}{p_m} }$$

Dado que 
$$\lim\limits_{m \rightarrow + \infty} 1 - (1 - p_m)^{ \frac{x}{p_m} } = 1 - \lim\limits_{m \rightarrow + \infty} (1 - p_m)^{ \frac{x}{p_m} } = 1 - \lim\limits_{m \rightarrow + \infty} \Big[ (1 - p_m)^{ \frac{1}{p_m} } \Big]^x = 1 - e^{-x} $$
