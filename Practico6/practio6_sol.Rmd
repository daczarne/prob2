...
$$= \exp\left\{ - \lim\limits_{n \rightarrow + \infty} \left[ \frac{n}{2} \left( \frac{-2it}{\sqrt{n}} - \frac{(-2it)^2}{2n} \right) + it \sqrt{n} \right] \right\} = \exp\left\{ - \lim\limits_{n \rightarrow + \infty} \left[ - it \sqrt{n} + \frac{t^2}{2} + it \sqrt{n} \right] \right\} = e^{-t^2 /2 }$$

Por lo tanto, $\sqrt{n} \big( \bar{Y}_n - 1 \big) \overset{d}{\rightarrow} Z \sim \text{N}(0, \, 1)$.
