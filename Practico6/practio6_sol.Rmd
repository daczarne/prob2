...
$$\sqrt{n} \Big[ f(Y_n(\omega)) - f(\mu) \Big] = \underbrace{ f'(X_n(\omega)) }_{ \overset{p}{\rightarrow} f'(\mu) } \underbrace{ \Big[ \sqrt{n} \big( Y_n(\omega) - \mu \big) \Big] }_{\overset{d}{\rightarrow} V \sim \text{N}(0, \, \sigma^2)} \overset{d}{\rightarrow} W \sim \text{N} \Big( 0, \sigma^2(f'(\mu))^2 \Big)$$
