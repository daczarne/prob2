...
i) $\sum\limits_{j = 1}^{n} \lambda_{nj} \overset{n}{\rightarrow} \lambda$

ii) $\delta_n = \max\limits_j|\lambda_{nj}| = \sqrt{ \max\limits_j \left( \lambda_{nj}^2 \right) } \leq \sqrt{ \sum\limits_{j = 1}^{n} \lambda_{nj}^2 } \overset{n}{\rightarrow} 0$

iii) $\delta_n \sum\limits_{j = 1}^{n} \left| \lambda_{nj} \right| \overset{n}{\rightarrow} 0$
...
<!--
$$\begin{array}{lcl}
y = -x \Rightarrow x = -y & & \frac{dx}{dy} = -1 \Rightarrow dx = -dy \\ \\
\text{Si } x \rightarrow -\infty \Rightarrow y \rightarrow + \infty & & \text{Si } x = 0 \Rightarrow y = 0
\end{array}$$
