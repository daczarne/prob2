...
i. $A_n = \bigcup\limits_{n = k}^{\infty} \Big\{ \omega \in \Omega \, : \, \big| X_n(\omega) - X(\omega) \big| > \varepsilon \Big\}$
...
$$F_{X_n} = \Phi_n(x) \overset{n}{\rightarrow} \Phi(x) = F_X(x) \Rightarrow X_n \overset{d}{\rightarrow} X$$
