...
Por lo tanto, resolver la integral propuesta implíca resolver $f_X(0)$. Por otro lado, dado que $X \sim \text{Unif}(-1, 1)$, sabemos que $f_X(x) = 1/2$ para todo $x \in [-1, 1]$. Por lo tanto,
