...
$$P(|X_n - X| > \varepsilon) = P(2|X| > \varepsilon) = P(|X| > \varepsilon / 2) = 2 \, \Phi(\varepsilon/2) > 0$$
...
$$\forall \varepsilon > 0, \,\,\,\,\,\, P(|X_n - X| > \varepsilon) = P(|X_n - X|^p > \varepsilon^p) \leq \frac{ E ( |X_n - X|^p ) }{ \varepsilon^p } \overset{n}{\rightarrow} 0$$
...
Luego entonces:
$$P( |X_n - 0| > \varepsilon) = P( X_n > \varepsilon) = P(X_n = e^n) = \frac{1}{n} \overset{n}{\rightarrow} 0 \Rightarrow X_n \overset{p}{\rightarrow} 0$$

Mientras que:
$$E( |X_n - 0|^p ) = E(|X_n|^p) = E(X^p) = (e^n)^p \frac{1}{n} + 0^p \left(1 - \frac{1}{n} \right) = e^{np} \overset{n}{\rightarrow} + \infty \Rightarrow X_n \not\overset{L^p}{\rightarrow} 0$$
