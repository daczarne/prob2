...
Comenzamos con la definición de convergencia en probabilidad de $X_n$ a 0, e "introducimos" $Y_n$ haciendo uso de que $P(A) = P(A \cap \Omega) = P(A \cap (B \cup \bar{B})) = P((A \cap B) \cup (A \cap \bar{B})) = P(A \cap B) + P(A \cap \bar{B})$ dado que $(A \cap B)$ y $(A \cap \bar{B})$ son independientes.
