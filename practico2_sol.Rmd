...
Por el ejercicio 1 parte c sabemos que si $g$ es continua y $X_n \overset{cs}{\rightarrow} X$, entonces $g(X_n) \overset{cs}{\rightarrow} g(X)$. Por el LFGN sabemos que $S_n / n \overset{cs}{\rightarrow} E(X_1)$. Por último, dado que $X_n$ es una sucesión iid de variables aleatorias iid con distribución $Unif(0, \theta]$, sabemos que $E(X_i) = \theta / 2$. Con esto entonces:
