...
$$\leq 1 - \exp\left\{ - E \left[ |X_n - Y| \, \mathbb{I}_{\{ |X_n - Y| > \varepsilon \}} \right] \right\} = $$
$$ = 1 - \exp\left\{ - P \big( |X_n - Y| > \varepsilon \big) \right\} \overset{n}{\rightarrow} 0 \Rightarrow d_p(X_n, Y) \overset{n}{\rightarrow} 0$$

Donde en la primera desigualdad utilizamos la no negatividad de la medida de distancia. En la segunda desigualdad utilizamos la desigualdad de Jensen. La tercera desigualdad se cumple por que $1 - e^{-(a+b)} \leq 1 - e^{-a}$ por ser $1 - e^{-(a+b)}$ monótona creciente en todos los reales.
