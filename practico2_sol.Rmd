...
$$E(X_n) = E [ g(\xi_n) ] = \int\limits_0^1 g(\xi_n) \underbrace{ f_{\xi_n}(\xi_n) }_{= 1} d\xi_n = \int\limits_0^1 g(\xi)_n d\xi_n$$
...
$$E(X_n^2) = E [ (g(\xi_n))^2 ] = \int\limits_0^1 \big( g(t) \big)^2 \, 1 dt = \int\limits_0^1 \big( g(t) \big)^2 dt$$
