...
<!--
$$= \frac{1}{ \sqrt{2 \pi} } \int\limits_{-\infty}^{+\infty} \big[ \cos(tx) + i \, \sin(tx) \big] e^{-x^2 / 2} dx = \frac{1}{ \sqrt{2 \pi} } \left[ \int\limits_{-\infty}^{+\infty} \cos(tx) e^{-x^2 / 2} dx + i \int\limits_{-\infty}^{+\infty} \sin(tx) e^{-x^2 / 2} dx \right] =$$
$$= \frac{1}{ \sqrt{2 \pi} } \int\limits_{-\infty}^{+\infty} \cos(tx) e^{-x^2 / 2} dx$$
-->
